...
void canny2(unsigned char *image, int rows, int cols, float sigma,
...
#endif //DUMMY
void canny3(float sigma, float tlow, float thigh, unsigned char **edge, char *filename)

{
   ...
   read_pgm_image(filename, &image, &rows, &cols);
   ...
   ****************************************************************************/
   ...
   write_pgm_image("c:\\temp\\canny2-gaussian.pgm", smoothedim, rows, cols, "", 255);
   /****************************************************************************
   ...
   ****************************************************************************/
   if(filename != NULL){
      ...
      *************************************************************************/
      /*if((fpdir = fopen(filname, "wb")) == NULL){
   ...
   ****************************************************************************/
   ...
   write_pgm_image("c:\\temp\\canny2.pgm", edge, rows, cols, "", 255);
   /****************************************************************************
...

{
  ...
  ImageInfo
   ...
   rows = image->rows;  cols = image->columns;
   pixels = GetImagePixels(image, 0,0, cols, rows);
